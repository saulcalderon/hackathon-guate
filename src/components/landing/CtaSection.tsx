    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 text-center max-w-4xl">
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 tracking-tight leading-tight">
          Find the best supplier <br className="hidden sm:block" />
          <span className="text-findrai-accent">in seconds</span>
        </h2>
        
        <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto leading-relaxed">
          Join modern procurement teams saving thousands every month. Upload your first invoice and see the magic in action.
        </p>
